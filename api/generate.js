...
function buildSystemPrompt(params) {
  ...
  prompt += '3bis. Le header doit contenir un menu de navigation dont CHAQUE lien pointe vers une ancre (#id) correspondant a une vraie section presente plus bas dans la page (ex: si tu crees une section Galerie avec id="galerie", le menu doit avoir un lien Galerie vers #galerie). Le menu mobile (hamburger) doit contenir exactement les memes liens que le menu desktop. Jamais de lien vide, de # sans destination, ou de menu qui ne correspond pas aux sections reellement generees.\n';
